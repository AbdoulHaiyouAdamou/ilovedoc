...
export default function PdfToJpgPage() {
  ...
  const handleConvert = async () => {
    ...
    try {
      const zipBlob = await convertPdfToImages(file, { format: 'jpg', quality }, setProgress);
    ...
    <>
      ...
      <main className="tool-page-layout" style={{ padding: 0, flex: 1, display: 'flex', flexDirection: 'column' }}>
          ...
          <div className="workspace">
              ...
              <div className="interval-block" style={{ maxWidth: '400px', padding: '2rem' }}>
                <div className="pdf-page-card" style={{ width: '220px', height: '300px', margin: '0 auto' }}>
                  ...
                  <div className="pdf-page-content" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', flex: 1, backgroundColor: 'var(--glass-bg)' }}>
                    <ImageIcon size={80} color={tool.color[0]} opacity={0.5} />
                  </div>
            ...
            <div className="workspace-sidebar">
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 12, marginBottom: 24 }}>
                ...
                >
                  <div style={{ padding: 8, background: `${tool.color[0]}15`, borderRadius: 8 }}>
                    <ImageIcon size={24} color={tool.color[0]} />
                  </div>
                  <div style={{ flex: 1 }}>
                    <div style={{ fontSize: 13, fontWeight: 700, color: tool.color[0], textTransform: 'uppercase', marginBottom: 4 }}>PAGE EN JPG</div>
                    <div style={{ fontSize: 13, color: 'var(--color-text-secondary)', lineHeight: 1.4 }}>Toutes les pages de ce PDF seront converties en un fichier JPG.</div>
                  </div>
                ...
                <button
                  ...
                  onClick={() => alert("L'extraction d'images natives est une fonctionnalité avancée en cours de développement. Le mode PAGE EN JPG sera utilisé.")}
                >
                  ...
                  <div style={{ flex: 1 }}>
                    ...
                    <div style={{ fontSize: 13, color: 'var(--color-text-secondary)', lineHeight: 1.4 }}>Toutes les images incrustées dans le fichier PDF seront extraites sous forme d'images JPG.</div>
                  </div>
                </button>
              </div>
              ...
              <div className="workspace-actions">
                ...
                >
                  Convertir en JPG <ChevronRight size={20} />
                </button>
              </div>
            </div>
          </div>
            ...
            <div className="container" style={{maxWidth: '800px', margin: '0 auto', textAlign: 'center', width: '100%'}}>
              {isProcessing ? (
                <div className="glass" style={{padding: '4rem', borderRadius: '1rem'}}>
                  ...
                  <p>Extraction des pages en JPG...</p>
                ...
                <div className="result-container glass" style={{padding: '4rem', borderRadius: '1rem'}}>
                  ...
                  <p style={{marginBottom: '2rem'}}>Le PDF a été converti en images JPG avec succès.</p>
                  <a 
                    href={downloadUrl!} 
        ...
        <div className="seo-content container-narrow">
          <AdUnit slot="ad-pdf-to-jpg-1" />
          <h2>Convertir PDF en JPG gratuit et sécurisé</h2>
          <p>
            Transformez facilement les pages de vos documents PDF en images JPG de haute qualité.
            Ce convertisseur PDF vers JPG fonctionne entièrement dans votre navigateur, garantissant que vos fichiers
            restent privés et ne sont jamais téléchargés sur un serveur distant.
          </p>
          <ul>
            <li><strong>100% Confidentiel</strong> : Tout le traitement se fait en local.</li>
            <li><strong>Haute résolution</strong> : Les images générées conservent une excellente qualité.</li>
            <li><strong>Archive ZIP</strong> : Téléchargez toutes vos pages converties d'un seul clic.</li>
          </ul>
